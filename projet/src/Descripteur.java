...
public class Descripteur {
	...
	// presentDef: recherche le nom d'une procédure dans tabDef
	//		rend son indice si présent, 0 sinon
	...
	// ajoutDef: ajoute une procédure de nom IdLu dans tabDef
	...
	// presentRef: recherche le nom d'une procédure dans tabRef
	//		rend son indice si présent, 0 sinon	
	...
	// ajoutRef: ajoute une procédure de nom IdLu dans tabRef
	...
	public void ecrireDesc(String nomFichier) {
		...
		if (f == null) {
			System.out
					.println("création de " + nomFichier + ".desc impossible");
			System.exit(1);
		}
