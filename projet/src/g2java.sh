...
ANTLR_JAR=$HOME/Cours/licence/compilation/projet/antlr/antlr-3.5.2-complete.jar
if [ ! -r $ANTLR_JAR ]
then
...
export CLASSPATH=$HOME/Cours/licence/compilation/projet/antlr/antlr-3.5.2-complete.jar:.:$CLASSPATH
